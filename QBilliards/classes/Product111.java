...
public class Product111 extends JFrame implements ActionListener
{
	...
	public Product111()
	{
		...
		lbl1 = new JLabel("SphereCraft");
		lbl1.setBounds(600,190,1400,40);
		lbl1.setFont(new Font("Rockwell", Font.BOLD, 22));
		panel.add(lbl1);
		 
		 
		lbl2 = new JLabel(new ImageIcon("image/A.jpg"));
		lbl2.setBounds(100,180,450,400);
		panel.add(lbl2);
		
		lbl3 = new JLabel("This entry level ball set comes in a standard size 38 mm.");
