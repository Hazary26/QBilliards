...
public class Product3 extends JFrame implements ActionListener
{
	...
	public Product3()
	{
		...
		lbl1 = new JLabel("Conelly");
		lbl1.setBounds(600,190,1400,40);
		lbl1.setFont(new Font("Rockwell", Font.BOLD, 25));
		panel.add(lbl1);
		
		lbl3 = new JLabel("External Dimensions: 260 x 148,Game Field Measurements: 224 x 112");
		...
		lbl2 = new JLabel(new ImageIcon("image/15.jpg"));
