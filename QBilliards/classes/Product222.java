...
public class Product222 extends JFrame implements ActionListener
{
	...
	public Product222()
	{
		...
		lbl1 = new JLabel("VelocityVista");
		lbl1.setBounds(600,190,1400,40);
		lbl1.setFont(new Font("Rockwell", Font.BOLD, 22));
		panel.add(lbl1);
		 
		 
		lbl2 = new JLabel(new ImageIcon("image/B.jpg"));
		lbl2.setBounds(100,180,450,400);
		panel.add(lbl2);
		
		
        lbl4 = new JLabel("Set ball Bs 38mm pool balls used for playing poll");
