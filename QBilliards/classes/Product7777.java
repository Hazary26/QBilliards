...
public class Product7777 extends JFrame implements ActionListener
{
	JPanel panel;
	...
	public Product7777()
	{
		...
		lbl1 = new JLabel("CueMasterGuard");
		lbl1.setBounds(600,190,1400,40);
		lbl1.setFont(new Font("Segoe UI", Font.BOLD, 25));
		panel.add(lbl1);
		 
		lbl3 = new JLabel(" Soft cue bag for billiard cue stick for a single cue divided in two parts.");
        lbl3.setBounds(610, 230, 4000, 40);
        lbl3.setFont(new Font("Rockwell", Font.BOLD, 15));
		panel.add(lbl3);

        
		lbl2 = new JLabel(new ImageIcon("image/36.jpg"));
