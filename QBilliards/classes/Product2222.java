...
public class Product2222 extends JFrame implements ActionListener
{
	JPanel panel;
	...
	public Product2222()
	{
		...
		panel.add(lbl1);
		 ...
		 lbl3 = new JLabel("Soft cue case for billiard cues.");
        lbl3.setBounds(610, 230, 4000, 40);
        lbl3.setFont(new Font("Rockwell", Font.BOLD, 15));
		panel.add(lbl3);

        
		lbl2 = new JLabel(new ImageIcon("image/31.jpg"));
