...
public class Product1111 extends JFrame implements ActionListener
{
	JPanel panel;
	...
	public Product1111()
	{
		...
		lbl1 = new JLabel("ProPocketGear ");
		lbl1.setBounds(600,190,1400,40);
		lbl1.setFont(new Font("Segoe UI", Font.BOLD, 25));
		panel.add(lbl1);
		
		lbl3 = new JLabel("The special zip guarantees high resistance to water splashes..");
        lbl3.setBounds(610, 230, 4000, 40);
        lbl3.setFont(new Font("Rockwell", Font.BOLD, 15));
		panel.add(lbl3);

		 
		lbl2 = new JLabel(new ImageIcon("image/30.jpg"));
