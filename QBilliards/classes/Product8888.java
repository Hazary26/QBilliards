...
public class Product8888 extends JFrame implements ActionListener
{
	JPanel panel;
	...
	public Product8888()
	{
		...
		lbl1 = new JLabel("VelvetStrikeBag");
		lbl1.setBounds(600,190,1400,40);
		lbl1.setFont(new Font("Segoe UI", Font.BOLD, 25));
		panel.add(lbl1);
		 
		lbl3 = new JLabel("Useful to protect your personal stick and take it with them in away games.");
        lbl3.setBounds(610, 230, 1400, 40);
        lbl3.setFont(new Font("Rockwell", Font.BOLD, 15));
		panel.add(lbl3);

        
		lbl2 = new JLabel(new ImageIcon("image/37.jpg"));
