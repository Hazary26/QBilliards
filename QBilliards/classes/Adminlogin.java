...
public class Adminlogin extends JFrame implements ActionListener
{
	...
	public Adminlogin()
	{
		...
		panel.add(lbl1);
		name1 = new JLabel("WELCOME TO QBILLIARDS");
		name1.setBounds(450,70,600,80);
		f1 = new Font("ADLaM Display",Font.BOLD, 40);
		name1.setFont(f1);
		...
		login.setBounds(580 ,480,300,40);
		...
		panel.setComponentZOrder(btn1, 0);
