...
public class Product777 extends JFrame implements ActionListener
{
	...
	public Product777()
	{
		...
		lbl1 = new JLabel("GravityGlide");
		lbl1.setBounds(600,190,1400,40);
		lbl1.setFont(new Font("Rockwell", Font.PLAIN, 22));
		panel.add(lbl1);
		 
		 
		lbl2 = new JLabel(new ImageIcon("image/H.jpg"));
		lbl2.setBounds(100,180,450,400);
		panel.add(lbl2);
		
		lbl3 = new JLabel("With this new Duramith formulation, the 4th generation Aramith for life products.");
        lbl3.setBounds(610, 230, 4000, 40);
        lbl3.setFont(new Font("Rockwell", Font.PLAIN, 15));
		panel.add(lbl3);
