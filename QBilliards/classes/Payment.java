   ...
   public Payment(double totalAmount)
    {
        ...
        //this.totalAmount = totalAmount;
//worked by meraz
        mainlogo = new ImageIcon("image\\main-logo.jpg");
...
/////////////////////////Credits_debits Buttons////////////
            Credits_debitsicon=new ImageIcon("image\\creditslabel.png");
...
/////////////////////////Mobile Banking Buttons////////////
        mobile_bankingicon=new ImageIcon("image\\bkashjpg.png");
...
/////////////////////////CryptoCurrency Buttons////////////
        cryptocurricon=new ImageIcon("image\\crptopayment.png");
...
//worked by meraz
        payment_go_back_icon = new ImageIcon("image\\backtest.png");
        ...
        //IMAGE ADD
        image =new JLabel();
        bg=new ImageIcon("image\\paymentmeraz.jpg");
        image.setIcon(bg);
