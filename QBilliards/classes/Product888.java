...
public class Product888 extends JFrame implements ActionListener
{
	...
	public Product888()
	{
		...
		lbl1 = new JLabel("Collapsar");
		lbl1.setBounds(600,190,1400,40);
		lbl1.setFont(new Font("Segoe UI", Font.PLAIN, 22));
		panel.add(lbl1);
		 
		 
		lbl2 = new JLabel(new ImageIcon("image/HH.jpg"));
		lbl2.setBounds(100,180,450,400);
		panel.add(lbl2);
		
		lbl3 = new JLabel(" New ball set of pool balls with duramith tecnology.");
