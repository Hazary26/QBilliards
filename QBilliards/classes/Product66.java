...
public class Product66 extends JFrame implements ActionListener
{
	...
	public Product66()
	{
		...
		lbl1 = new JLabel("Brunswick");
		lbl1.setBounds(600,190,1400,40);
		lbl1.setFont(new Font("Rockwell", Font.BOLD, 25));
		panel.add(lbl1);
		 
		 
		lbl2 = new JLabel(new ImageIcon("image/8.jpg"));
		lbl2.setBounds(100,180,450,400);
		panel.add(lbl2);
		
		lbl3 = new JLabel("This model have red inhails and a nice pattern.");
        lbl3.setBounds(610, 230, 4000, 40);
        lbl3.setFont(new Font("Rockwell", Font.BOLD, 19));
		panel.add(lbl3);
